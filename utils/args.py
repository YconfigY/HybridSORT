...
def make_parser():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="evaldata/trackers/mot_challenge"
    )
    parser.add_argument(
        "--dist-url",
        default=None,
    ...
    parser.add_argument(
        ...
        default=3,
        type=int,
        help="min hits to create track in SORT"
    )
    parser.add_argument(
        "--inertia",
        default=0.2,
    ...
    parser.add_argument(
        "--public",
        action="store_true",
        help="use public detection"
    )
    parser.add_argument(
        '--asso',
        default="iou",
        help="similarity function: iou/giou/diou/ciou/ctdis"
    )
    parser.add_argument(
        "--use_byte",
        dest="use_byte",
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="use TCM in byte step."
    )
    parser.add_argument(
        "--TCM_first_step_weight",
        type=float,
        default=1.0,
        help="TCM first step weight"
    )
    parser.add_argument(
        "--TCM_byte_step_weight",
        type=float,
        default=1.0,
        help="TCM second step weight"
    )
    parser.add_argument(
        "--hybrid_sort_with_reid",
        default=False,
        action="store_true",
        help="use ReID model for Hybrid SORT."
    )
    ...
    parser.add_argument(
        ...
        help="threshold of low score detections for BYTE"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=0.8,
        type=float,
        help="momentum of embedding update"
    )
    parser.add_argument(
        "--with_fastreid",
        dest="with_fastreid",
        default=False,
        action="store_true",
        help="use FastReID flag."
    )
    parser.add_argument(
        "--fast_reid_config",
        dest="fast_reid_config",
        default=r"fast_reid/configs/CUHKSYSU_DanceTrack/sbs_S50.yml",
        type=str,
    ...
    parser.add_argument(
        ...
        default=r"fast_reid/logs/CUHKSYSU_DanceTrack/sbs_S50/model_final.pth",
        type=str,
        help="reid weight path"
    )
    parser.add_argument(
        "--with_longterm_reid",
        dest="with_longterm_reid",
        default=False,
        action="store_true",
    ...
    parser.add_argument(
        ...
        dest="with_longterm_reid_correction",
        default=False,
        action="store_true",
        help="use long-term reid features for association correction."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help="max length of reid feat bank"
    )
    parser.add_argument(
        "--adapfs",
        dest="adapfs",
    ...
    parser.add_argument(
        "--hp",
        action="store_true",
        help="use head padding to add the missing objects during initializing the tracks (offline)."
    )
